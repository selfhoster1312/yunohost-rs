...
OK    OK (0.13s)                   OK (0.00s)  yunohost hook list --json conf_regen
OK    OK (0.19s)                   OK (0.02s)  yunohost settings get --json security
...
SKIP  ERROR - /tmp/tmp.KvHzwqHr4e  OK (0.00s)  yunohost tools regen-conf --list-pending --with-diff --json
OK    OK (0.18s)                   OK (0.00s)  yunohost user list --json
OK    OK (0.51s)                   OK (0.02s)  yunohost user info --json test2
```
